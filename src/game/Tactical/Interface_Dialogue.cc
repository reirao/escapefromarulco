...
void InternalInitTalkingMenu(UINT8 const ubCharacterNum, INT16 sX, INT16 sY)
{
	...
	// OS//0 uses the original JA2 talking head and dialogue controls as the
	// conversation state of its single Field Computer, rather than spawning a
	// second independent panel over the tactical view.
	OS0PlaceTalkingPanel(gTalkPanel.usWidth, gTalkPanel.usHeight, &sX, &sY);
