...
namespace
{
	constexpr std::array<OS0UICommandDescriptor,
		...
		{ OS0UICommand::TACTICAL, "COMBAT",
			"COMBAT MODE / WASD MOVE / LMB FIRE", OS0UIIcon::TARGET,
			OS0UICommandIntent::TOGGLE_COMBAT_MODE },
		{ OS0UICommand::CHARACTER, "CHARACTER",
			"CHARACTER / ACTIONS / GEAR / GROUP / GOD", OS0UIIcon::HAND,
		...
		{ OS0UICommand::OBJECT, "SCAN",
			"F: PERCEIVE OBJECT / NEARBY SCAN", OS0UIIcon::LOOK,
