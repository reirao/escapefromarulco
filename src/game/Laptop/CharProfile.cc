...
static void CreateIMPButtons(void)
{
	// OS//0 has one local navigation control instead of the old web cancel button.
	giIMPButtonImage[0] = nullptr;
	giIMPButton[0] = CreateTextButton("BACK", FONT12ARIAL, FONT_MCOLOR_RED, FONT_BLACK,
		LAPTOP_SCREEN_UL_X + 28, LAPTOP_SCREEN_WEB_UL_Y + 330, 105, 48,
		MSYS_PRIORITY_HIGH, BtnIMPCancelCallback);
	giIMPButton[0]->SpecifyHilitedTextColors(FONT_WHITE, FONT_BLACK);
