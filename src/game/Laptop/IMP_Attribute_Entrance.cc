...
static void CreateIMPAttributeEntranceButtons(void)
{
	...
	giIMPAttributeEntranceButton[0] = CreateTextButton(
						"CONFIGURE ATTRIBUTES", FONT12ARIAL, FONT_MCOLOR_RED, FONT_BLACK,
						LAPTOP_SCREEN_UL_X + 136, LAPTOP_SCREEN_WEB_UL_Y + 314, 230, 48,
						MSYS_PRIORITY_HIGH, BtnIMPAttributeBeginCallback);
	giIMPAttributeEntranceButton[0]->SpecifyHilitedTextColors(FONT_WHITE, FONT_BLACK);
