...
static void CreateIMPHomePageButtons(void)
{
	...
	giIMPHomePageButton[0] = CreateTextButton(
					"CREATE OPERATOR", FONT12ARIAL, FONT_MCOLOR_RED, FONT_BLACK,
					LAPTOP_SCREEN_UL_X + 136, LAPTOP_SCREEN_WEB_UL_Y + 200,
					230, 48, MSYS_PRIORITY_HIGH, BtnIMPAboutUsCallback);
	giIMPHomePageButton[0]->SpecifyHilitedTextColors(FONT_WHITE, FONT_BLACK);
