...
static void CreateIMPPersonalityEntranceButtons(void)
{
	...
	giIMPPersonalityEntranceButtonImage[0] = LoadButtonImage(LAPTOPDIR "/button_2.sti", 0, 1);
		giIMPPersonalityEntranceButton[0] = CreateTextButton(
							"CONFIGURE TRAITS", FONT12ARIAL, FONT_MCOLOR_RED, FONT_BLACK,
							LAPTOP_SCREEN_UL_X + 136, LAPTOP_SCREEN_WEB_UL_Y + 314, 230, 48,
							MSYS_PRIORITY_HIGH, BtnIMPPersonalityEntranceDoneCallback);
		giIMPPersonalityEntranceButton[0]->SpecifyHilitedTextColors(FONT_WHITE, FONT_BLACK);
