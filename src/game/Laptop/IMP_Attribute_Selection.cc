...
static void CreateIMPAttributeSelectionButtons(void)
{
	...
	giIMPAttributeSelectionButton[0] = CreateTextButton(
		"CONFIRM ATTRIBUTES", FONT12ARIAL, FONT_MCOLOR_RED, FONT_BLACK,
		LAPTOP_SCREEN_UL_X + 136, LAPTOP_SCREEN_WEB_UL_Y + 314, 230, 48,
		MSYS_PRIORITY_HIGH, BtnIMPAttributeFinishCallback);
	giIMPAttributeSelectionButton[0]->SpecifyHilitedTextColors(FONT_WHITE, FONT_BLACK);
...
static void CreateAttributeSliderButtons(void)
{
	...
	for (INT32 iCounter = 0; iCounter < 20; iCounter += 2)
	{
		...
		giIMPAttributeSelectionSliderButton[iCounter] = CreateTextButton(
			"-", FONT12ARIAL, FONT_MCOLOR_RED, FONT_BLACK,
			LAPTOP_SCREEN_UL_X + 163, y, 18, 18, MSYS_PRIORITY_HIGHEST - 1,
			BtnIMPAttributeSliderLeftCallback);
		giIMPAttributeSelectionSliderButton[iCounter + 1] = CreateTextButton(
			"+", FONT12ARIAL, FONT_MCOLOR_RED, FONT_BLACK,
			LAPTOP_SCREEN_UL_X + 426, y, 18, 18, MSYS_PRIORITY_HIGHEST - 1,
