...
5. Open and loot a container; verify that opening does not instantly close it.
6. Carry a movable container and place it on another valid tile.
7. Right-click nearby grass or dirt and use `DIG`.
8. Aim while panels are open and verify that they do not obstruct the shot.
9. Save, reload and revisit changed terrain or moved objects.
